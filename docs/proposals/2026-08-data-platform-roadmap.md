...
| S2 | P1 | Product serving marts | blocked by S1 baseline | Profile and practice queries use release-built marts where measurements prove benefit; provenance and raw evidence remain intact | — |
