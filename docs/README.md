...
| [product-serving-marts.md](product-serving-marts.md) | Executable contract reference for twelve foundation marts, six serving tables, and the measured S2/S3 route-migration boundary. |
| [utilization-search.md](utilization-search.md) | HCPCS/drug dictionaries and code-first ranked NPI search contract for Provider Search Cases. |
...
| [operations/s2-nppes-primary-production-cutover-2026-08-14.md](operations/s2-nppes-primary-production-cutover-2026-08-14.md) | Successful NPPES-primary serving-mart production cutover, rollback proof, capacity result, and end-to-end verification. |
| [operations/s3-provider-profile-preflight-2026-08-14.md](operations/s3-provider-profile-preflight-2026-08-14.md) | Provider-profile source readiness, capacity recovery, reassignment provenance adoption, and first-build null-ZIP learning. |
| [operations/s3-provider-profile-candidate-2026-08-14.md](operations/s3-provider-profile-candidate-2026-08-14.md) | Isolated provider-profile candidate build, parity corrections, plan and concurrency results, no-cutover decision, and next-slice sequence. |
| [operations/s3-provider-profile-candidate-retention-cleanup-2026-08-14.md](operations/s3-provider-profile-candidate-retention-cleanup-2026-08-14.md) | Controlled removal of the superseded S3 staging database, production-health guard, and restored candidate-build headroom. |
| [operations/s3-provider-profile-complete-candidate-2026-08-15.md](operations/s3-provider-profile-complete-candidate-2026-08-15.md) | Six-table provider-profile candidate identity, provenance recovery, exact parity, performance gates, rollback rehearsal, and capacity-blocked production decision. |
...
| [operations/july-refresh-workspace-compaction-2026-08-14.md](operations/july-refresh-workspace-compaction-2026-08-14.md) | July rebuild workspace inventory, unique-source retention decision, duplicate compaction proof, and restored S2 capacity gate. |
...
| [proposals/2026-08-s3-provider-profile-serving-plan.md](proposals/2026-08-s3-provider-profile-serving-plan.md) | Provider-profile header/location/group mart design, staging boundary, evaluation gates, and later profile slices. |
