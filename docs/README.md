...
| [operations/s3-provider-profile-preflight-2026-08-14.md](operations/s3-provider-profile-preflight-2026-08-14.md) | Provider-profile source-readiness, parity learning, capacity block, and reviewed cleanup candidates before any production-data build. |
