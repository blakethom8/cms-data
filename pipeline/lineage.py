...
TRANSFORMS: tuple[TransformSpec, ...] = (
    ...
    TransformSpec(
        "build_provider_address_evidence",
        "Build provider address evidence",
        (
            "raw_nppes",
            "raw_dac_national",
            "raw_physician_by_provider",
        ...
        "Preserves source-specific provider address records without selecting a primary address.",
    ),
    TransformSpec(
        "build_provider_organization_evidence",
        "Build provider organization evidence",
        (
            "raw_dac_national",
            "raw_reassignment",
        ...
        "Preserves published and derived provider-organization relationships without selecting a primary organization.",
    ),
    TransformSpec(
