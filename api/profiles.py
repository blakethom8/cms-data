...
def _profile_claims_summary(
    ...
    row = _row(conn, """
        select has_panel, medicare_patients,
               ...
               avg_hcc_risk_score,
               cast(pct_hypertension as BIGINT) pct_hypertension,
               cast(pct_hyperlipidemia as BIGINT) pct_hyperlipidemia,
               cast(pct_diabetes as BIGINT) pct_diabetes,
               cast(pct_ischemic_heart as BIGINT) pct_ischemic_heart,
               cast(pct_heart_failure as BIGINT) pct_heart_failure,
               cast(pct_afib as BIGINT) pct_afib,
               cast(pct_ckd as BIGINT) pct_ckd,
               cast(pct_copd as BIGINT) pct_copd,
               cast(pct_depression as BIGINT) pct_depression, has_clinical,
